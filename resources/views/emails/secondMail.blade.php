...
<table align="center"  cellpadding="0" cellspacing="0" width="600" style="border: 1px solid grey;">
    ...
    <tr style="background-color: #dfe4eb;">
        <td style="font-size: 14px;padding: 10px;">
            ...
            <p><b>Привет,</b></p>
            <p>Вчера вы добавили в корзину товары и не завершили заказ.
                Если они вам еще нужны, то я просто напомню, что мы зарезервировали
                их специально для вас, но <b> резерв истечет уже через 2 дня. </b> </p>
        </td>
    </tr>
    ...
    <tr style="border: 10px dot-dot-dash grey;">
        <a href="https://booksmoscow.ru/cart?utm_source=email&utm_medium=bk&utm_campaign=bk_1d">
