...
<html>
<head>
    <title>Отправленные купоны BooksMoscow</title>
...
<div class="container box">
    <h3 align="center">Отправленные купоны BooksMoscow</h3><br />
        ...
        <div class="panel-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tr>
                        <th width="15%">Id</th>
                        <th width="50%">Email пользователя</th>
                        <th width="15%">Купон отправлен</th>
                        <th width="20%">Дата</th>
                    </tr>
                    </thead>
                    <tbody>
...
<script>
    $(document).ready(function(){
        ...
        {
            $.ajax({
                url:"{{ route('cuponDateRange.fetch_data') }}",
                method:"POST",
